...
-- 📌 Переменная для ввода ключа (вы можете заменить эту строку на любое другое значение, если хотите тестировать)
local script_key = "B0mF2R6V1x7Qn8Ls"  -- Убедитесь, что вводите ключ правильно, если хотите тестировать
